        ...
        <div id="wd-modules-controls" className="text-nowrap">
            ...
            <div className="dropdown d-inline me-1 float-end">
                ...
                <ul className="dropdown-menu">
                    ...
                    {/* DONE~~~~~Create two more items with IDs wd-unpublish-all-modules-and-items and
                        wd-unpublish-modules-only with labels Unpublish all modules and items
                    and Unpublish modules only  DONE~~~~*/}
                </ul>
            </div>
            <div className="d-inline me-1 float-end">
                <button id="wd-view-progress-btn" className="btn btn-lg float-end btn-secondary">
                    View Progress
                </button>
            </div>

            <div className="d-inline me-1 float-end">
                <button id="wd-collapse-all-btn" className="btn btn-lg float-end btn-secondary">
                    Collapse All
                </button>
            </div>
