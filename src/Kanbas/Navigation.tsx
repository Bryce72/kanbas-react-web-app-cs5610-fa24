...
/**
 * list-group-item text-center border-0 bg-white text-danger    -- this is how i want it to be WHEN ACTIVE
 * list-group-item text-center border-0 bg-black text-white     -- this is how i want it to be WHEN NOTACTIVE
 * 
 * 
 * ACCOUNT WHEN ACTIVE :
